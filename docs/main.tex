...
\begin{figure*}[htbp]
\centerline{\includegraphics[width=0.86\textwidth]{figures/bert_encoder_stack.png}}
...
\begin{figure*}[htbp]
\centerline{\includegraphics[width=0.84\textwidth]{figures/fake_quant_pipeline.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/dp_allocation_diagram_column.png}}
...
\begin{figure*}[htbp]
\centerline{\includegraphics[width=0.92\textwidth]{figures/bertbase_sensitivity_heatmap.png}}
...
\begin{figure*}[htbp]
\centerline{\includegraphics[width=0.92\textwidth]{figures/bertbase_tradeoff.png}}
...
\section*{Appendix}
\subsection*{A. Github Repository for this project}
https://github.com/AthillaZaidan/TransformerCompression
\subsection*{B. Youtube Video}
https://youtu.be/jFTqL7NzckI
...
\vspace{4pt}
\noindent\includegraphics[width=0.26\columnwidth]{figures/tanda-tangan.png}
